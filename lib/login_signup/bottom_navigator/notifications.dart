...
class Notifications extends StatelessWidget {
      ...
      appBar: PreferredSize(
        ...
        child: Container(
          decoration: BoxDecoration(
            color: const Color.fromARGB(255, 3, 1, 7),
            border: Border.all(
              color: const Color.fromARGB(255, 246, 7, 7), // Neon border color
              width: 2,
            ),
            boxShadow: [
              BoxShadow(
                color: const Color.fromARGB(255, 233, 6, 6).withOpacity(0.8),
                blurRadius: 10,
                spreadRadius: 2,
  ...
  title: Row(
    children: [
      ...
      drawer: Drawer(
        backgroundColor: const Color.fromARGB(255, 7, 4, 12), // Drawer background color
        child: ListView(
          padding: EdgeInsets.zero,
          children: [
            DrawerHeader(
              decoration: BoxDecoration(
                color: const Color.fromARGB(255, 0, 0, 0), // Drawer header background color
              ),
              child: const Column(
      ...
      bottomNavigationBar: Container(
        decoration: BoxDecoration(
          color: const Color.fromARGB(255, 14, 1, 1), // Background color
          border: Border.all(
            color: const Color.fromARGB(255, 238, 5, 5), // Neon border color
            width: 2,
          ),
          boxShadow: [
            BoxShadow(
              color: const Color.fromARGB(255, 250, 6, 6).withOpacity(0.8),
              blurRadius: 10,
              spreadRadius: 2,
              offset: const Offset(0, 0),
            ),
        ...
        child: BottomNavigationBar(
          ...
          selectedItemColor: const Color.fromARGB(255, 243, 240, 242), // Selected icon color
          unselectedItemColor: const Color.fromARGB(255, 238, 5, 5), // Unselected icon color
